...
public class BookAppointmentJPanel extends JPanel{
	...
	private final String bookHolidayButton="Book Holiday";
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch(event){
					...
					try {
						...
						System.out.println("empid = " + emp_id + "patient_id = " + patient_id );
					...
					case bookHolidayButton:
						...
						selectedStartMinute = startMinuteList[0];
						selectedEndHour = endHourList[8];
						selectedEndMinute = endMinuteList[0];
						String start_time = selectedStartHour + ":" + selectedStartMinute + ":00";
						String end_time = selectedEndHour + ":" + selectedEndMinute + ":00";
						...
						try {
							dbQueries.bookAppointment(emp_id, 13, date, start_time, end_time);
						} catch (SQLException e1) {}
					}
				}
	...
	public BookAppointmentJPanel() {
		...
		holidayButton = new JButton(bookHolidayButton);
		holidayButton.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		holidayButton.addActionListener(new ButtonHandler());
	...
	void updateResultView(String conf, String planType){
